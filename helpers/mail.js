...
module.exports = async function SendMail(
  ...
  const mailBody = {
    ...
    <body style="background-color:#EEEEEE;border-radius:20px">
      <div style="margin:20px;display:flex;flex-direction:row;flex-wrap: wrap;justify-content: space-around;">
        <h3 style="color:#3A4043">Password Hub</h3>
        <img src="https://cdn2.iconfinder.com/data/icons/seo-web-2-3/128/Vigor_https-safe-secure-security-shield-ssl-browse-256.png" alt="" width="50px">
      </div>
      <div style="margin:10px;border:5px solid #859AFF">
        <center>
          <h4 style="color:#3A4043">Hi ${name},</h4>
          <p style="color:#363636">You have successfully created a Password Hub account,<br/>Please click on the link below to verify your email<br/> address and complete your registration</p>
      <br/>
      ...
      <div style="margin:20px;display:flex;flex-direction:row;flex-wrap: wrap;justify-content: space-around;">
        <small style="color:#3A4043">&copy 2021 Password Hub</small>
      </div>
      </body>
    `,
    forgot: `
    <body style="background-color:#EEEEEE;border-radius:20px">
  <center>
    <h1 style="font-family:Times New Roman;">Password Hub</h1>
  </center>
      <div style="margin:10px;border:5px solid #859AFF">
        <center>
      ...
      <div style="margin:20px;display:flex;flex-direction:row;flex-wrap: wrap;justify-content: space-around;">
        <small style="color:#3A4043">© 2022 Password Hub</small>
      </div>
      </body>
    `,
  };
  ...
  let info = await transporter.sendMail({
    from: `"Password Hub"  <${admin_mail}>`, // sender address
